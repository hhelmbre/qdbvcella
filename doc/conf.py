...
# -*- coding: utf-8 -*-
#
# qdbvcella documentation build configuration file, created by
...
htmlhelp_basename = 'qdbvcelladoc'
...
latex_documents = [
  ('index', 'qdbvcella.tex', 'qdbvcella Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'qdbvcella', 'qdbvcella Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'qdbvcella', 'qdbvcella Documentation',
   'Ariel Rokem', 'qdbvcella', 'One line description of project.',
   'Miscellaneous'),
]
